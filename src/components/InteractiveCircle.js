...
class InteractiveCircle extends Component {
  ...
  render() {
    ...
    return (
      <div className = 'interactiveCircle bg-colmena' style = {{ 'marginTop': 40, 'marginLeft': -480 }}>
        {
          ...
          <div className = 'bgItemGlobe'>
            <div
              ...
              <p className = 'mB-05 color-5' dangerouslySetInnerHTML = { { __html: multimediaCircular[actualItem - 1].itemInfo.text } } />

              <p className = ''>{ multimediaCircular[actualItem - 1].itemInfo.text2 }</p>
