...
import DraggablePuzzle from '../../components/DraggablePuzzle';
...
import SlidesGlobe from '../../components/SlidesGlobe';
      ...
      <div className = 'pageContent animated fadeIn' style = { style }>
        <div className='pT-4'>
          <div className = 'section-title d-Flex j-S aI-S c-9'>
            <div className = 'c-5 d-Flex d-C j-C aI-S mL-3'>
              <h2 className = 'mB-5' dangerouslySetInnerHTML = {{ __html: dataPage.jumboText1 }} />

              <Instruction dataPage = { dataPage.instruction } />
            </div>
          </div>

          <div className = 'dndZone c-10'>
            <DraggablePuzzle multimedia = { dataPage.multimedia } handleClick = { this.handleClick } isEnded = { this.isEnded } />
          </div>
        </div>
      </div>
    );
...
class Page3 extends Component {
  ...
  render() {
    ...
    return (
      <div className = 'pageContent animated fadeIn' style = { style }>
        <div className='pT-4'>
          <div className = 'section-title d-Flex j-S aI-S c-9 mB-7'>
            <div className = 'c-5 d-Flex d-C j-C aI-S mL-3'>
              <h2 className = 'mB-5' dangerouslySetInnerHTML = {{ __html: dataPage.jumboText1 }} />
          ...
          <div className = 'c-10'>
            <SlidesGlobe dataPage = { dataPage.multimedia } isEnded = { this.isEnded } />
          </div>
        </div>
      </div>
    );
  ...
  render() {
    ...
    return (
      <div className = 'pageContent animated fadeIn' style = { style }>
        <div className='pT-4'>
          <div className = 'section-title d-Flex j-S aI-S c-9 mB-7'>
            <div className = 'c-6 d-Flex d-C j-C aI-S mL-3'>
              <h2 className = 'mB-5' dangerouslySetInnerHTML = {{ __html: dataPage.jumboText1 }} />
  ...
  render() {
    ...
    return (
      <div className = 'pageContent animated fadeIn' style = { style }>
        <div className='pT-4'>
          <div className = 'section-title d-Flex j-S aI-S c-9 mB-7'>
            <div className = 'c-8 d-Flex d-C j-C aI-S mL-3'>
...
class Page6 extends Component {
  ...
  render() {
    ...
    return (
      <div className = 'pageContent animated fadeIn' style = { style }>
        <div className='pT-4'>
          <div className = 'section-title d-Flex d-C j-S aI-S c-10 pL-2 pR-2 mB-7'>
            <div className = 'c-5 d-Flex d-C j-C aI-S mL-3'>
              <h2 className = 'mB-3' dangerouslySetInnerHTML = {{ __html: dataPage.jumboText1 }} />

              <Instruction dataPage = { dataPage.instruction } />
            </div>

            <div className = 'c-10 d-Flex j-S aI-C mT-1'>
  ...
  render() {
    ...
    return (
      <div className = 'pageContent animated fadeIn' style = { style }>
        <div className='pT-4'>
          <div className = 'section-title d-Flex d-C j-S aI-S c-10 pL-2 pR-2 mB-7'>
            <div className = 'c-4 d-Flex d-C j-C aI-S mL-3 mB-2'>
              <h2 className = 'mB-3' dangerouslySetInnerHTML = {{ __html: dataPage.jumboText1 }} />

              <Instruction dataPage = { dataPage.instruction } />
            </div>

            <div className = 'c-10 d-Flex j-C aI-C mT-1'>
  ...
  render() {
    ...
    return (
      <div className = 'pageContent animated fadeIn' style = { style }>
        <div className='pT-4'>
          <div className = 'section-title d-Flex d-C j-S aI-S c-10 pL-2 pR-2 mB-7'>
            <div className = 'c-5 d-Flex d-C j-C aI-S mL-3 mB-1'>
              <h2 className = '' dangerouslySetInnerHTML = {{ __html: dataPage.jumboText1 }} />
  ...
  render() {
    ...
    return (
      <div className = 'pageContent animated fadeIn' style = { style }>
        <div className='pT-4'>
          <div className = 'section-title d-Flex d-C j-S aI-S c-10 pL-2 pR-2 mB-7'>
            <div className = 'c-5 d-Flex d-C j-C aI-S mL-3 mB-2'>
              <h2 className = '' dangerouslySetInnerHTML = {{ __html: dataPage.jumboText1 }} />
            </div>
...
class Page12 extends Component {
  render() {
    ...
    return (
      <div className = 'pageContent animated fadeIn' style = { style }>
        <div className = 'd-Flex j-C aI-C c-10 pT-6 pL-3'>
          ...
          <div className="c-5 dF-R-cc">
            {
              dataPage.resources.img1 ? <img
                alt = 'Imagen'
                className = ''
                src = { dataPage.resources.img1 }/> : null
            }
          </div>
        </div>
      </div>
    ...
    return (
      <div className={ 'pageContent ' + (dataPage.type) + ' dF-R-sc pL-3 animated fadeIn' } style = { style }>
        <div className="c-5 dF-C-cs mB-4">
          ...
          {
            dataPage.msjInfo ? <p className = 'bg-color-19 pT-1 pB-1 pL-2 pR-2 color-4 F1' style = { { 'borderRadius': 50 } }> { dataPage.msjInfo } </p> : null
          }
